    ...
    <RouteWrapper accessibilityLabel="About Group">
      <Card title="About">
        <Text>
          ...
          and fuel grade. It uses EIA government data to get the latest reports.
          My main goal with this app was to build it with modularity,
          ...
          were to add more features. The front end can be compiled for Android
